...
summary: Evolution of a proprietary, production-grade sales management platform developed and operated for over a decade, transitioning toward explicit architectural boundaries, a BFF layer, and a long-term microservices target architecture.
  ...
  images={[
    {
      ...
      caption: "Operational dashboard with sales views, channel-level summaries, and alerts supporting day-to-day work."
    },
    {
      src: "/case-studies/commerce-platform-modernization/commerce-platform-modernization-screenshot_1_2.png",
      alt: "Dashboard with sales metrics",
      caption: "Main dashboard screen showing sales charts and an order split across seller accounts."
    },
    {
      src: "/case-studies/commerce-platform-modernization/commerce-platform-modernization-screenshot_1_3.png",
      alt: "Seller account switching",
      caption: "Dashboard view with the seller-account switcher expanded, highlighting the platform's multi-organization model."
    },
    {
      src: "/case-studies/commerce-platform-modernization/commerce-platform-modernization-screenshot_1_4.png",
      alt: "User account menu",
      caption: "User menu with account settings and session controls, embedded in a consistent application shell."
    },
    {
      src: "/case-studies/commerce-platform-modernization/commerce-platform-modernization-screenshot_2_1.png",
      alt: "In-progress orders list",
      caption: "Orders list with filters, operational statuses, product details, and actions performed directly from the table."
    },
    {
      src: "/case-studies/commerce-platform-modernization/commerce-platform-modernization-screenshot_2_2.png",
      alt: "Shipped orders list",
      caption: "Post-shipment orders view with additional logistics columns, tracking numbers, and operation history."
    },
    {
      src: "/case-studies/commerce-platform-modernization/commerce-platform-modernization-screenshot_3_1.png",
      alt: "Returns and complaints handling",
      caption: "Returns and complaints panel with dedicated process statuses and contextual record filtering."
    },
    {
      src: "/case-studies/commerce-platform-modernization/commerce-platform-modernization-screenshot_4_1.png",
      alt: "Message center",
      caption: "Message module built around threaded communication, combining a conversation list with details and reply flow."
    },
    {
      src: "/case-studies/commerce-platform-modernization/commerce-platform-modernization-screenshot_5_1.png",
      alt: "Operational notifications",
      caption: "System notifications view aggregating operational events, comments, and new orders in one place."
    },
    {
      ...
      caption: "Audit trail of user actions and system processes with filters by time, action type, and linked entities."
    },
    {
      src: "/case-studies/commerce-platform-modernization/commerce-platform-modernization-screenshot_7_1.png",
      alt: "Seller accounts list",
      caption: "Administrative section with a seller account list and core organizational data."
    },
    {
      src: "/case-studies/commerce-platform-modernization/commerce-platform-modernization-screenshot_7_2.png",
      alt: "Organization settings tiles",
      caption: "Entry point to organization configuration covering stores, invoicing, carriers, email, and other back-office modules."
    },
    {
      src: "/case-studies/commerce-platform-modernization/commerce-platform-modernization-screenshot_7_3.png",
      alt: "Invoice data settings",
      caption: "Invoice data configuration form as an example of a classic administrative module within the platform."
    },
    {
      ...
      caption: "Configuration of email templates and notification activation for different sales sources and recipient types."
    }
  ]}
/>

_UI screenshots are shown with anonymized data and removed branding._
...
It is a production-proven operational platform being transformed in a controlled, contract-driven way by the same team that designed and operated it from the beginning.
