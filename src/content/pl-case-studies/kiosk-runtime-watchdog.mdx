---
title: Kioskowy runtime watchdog dla publicznych, bezobsługowych urządzeń
summary: Projekt minimalnej, odpornej na awarie warstwy nadzorującej runtime, odpowiedzialnej za kontrolę i odzyskiwanie webowej aplikacji kioskowej działającej na publicznych, bezobsługowych maszynach.

category: Systemy i architektura
featured: false
priority: 70
tags: ["kiosk", "watchdog", "systemy publiczne", "niezawodność", "bezobsługowy runtime", "odzyskiwanie po awarii", "architektura systemów"]
links:
  - label: Architecture showcase (GitHub)
    href: "https://github.com/rocketdeploy-dev/showcase-kiosk-runtime-watchdog"
    kind: repo
  - label: Powiązane case study – aplikacja kioskowa
