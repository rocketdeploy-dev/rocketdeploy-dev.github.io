---
title: Operacyjna aplikacja SPA z kontrolą ról dla systemów wewnętrznych
summary: Projekt i implementacja produkcyjnej aplikacji typu single-page, wykorzystywanej jako interfejs operacyjny dla zespołów wewnętrznych, zaprojektowanej z myślą o wyraźnych granicach architektonicznych i długoterminowej ewolucji.

category: Architektura frontendu
featured: true
priority: 80
tags: ["spa", "angular", "typescript", "rbac", "architektura frontendu", "bff", "operacje", "narzędzia wewnętrzne"]
links:
  ...
  images={[
    {
      ...
      alt: "Lista pracowników (tryb ciemny)",
      caption: "Lista pracowników w trybie ciemnym z oznaczeniami ról/statusów i szybkimi akcjami."
    },
    {
      src: "/case-studies/internal-operational-spa/1_2.png",
      alt: "Szczegóły pracownika (tryb ciemny)",
      caption: "Widok profilu pracownika w trybie ciemnym z danymi kontaktowymi, rolami/obszarami i preferencjami powiadomień."
    },
    {
      src: "/case-studies/internal-operational-spa/1_3.png",
      alt: "Lista pracowników (tryb jasny)",
      caption: "Lista pracowników w trybie jasnym ze spójnym układem, oznaczeniami i szybkimi akcjami."
    },
    {
      src: "/case-studies/internal-operational-spa/1_4.png",
      alt: "Szczegóły pracownika (tryb jasny)",
      caption: "Widok profilu pracownika w trybie jasnym z przypisaniami ról/obszarów i ustawieniami powiadomień."
    },

    {
      src: "/case-studies/internal-operational-spa/2_1.png",
      alt: "Lista punktów usługowych (tryb ciemny)",
      caption: "Lista punktów usługowych w trybie ciemnym ze statusem operacyjnym i tagami możliwości/usług."
    },
    {
      src: "/case-studies/internal-operational-spa/2_2.png",
      alt: "Szczegóły punktu usługowego (tryb ciemny)",
      caption: "Widok szczegółów punktu usługowego w trybie ciemnym łączący adres, usługi i współrzędne."
    },
    {
      src: "/case-studies/internal-operational-spa/2_3.png",
      alt: "Lista punktów usługowych (tryb jasny)",
      caption: "Lista punktów usługowych w trybie jasnym z tą samą hierarchią informacji i układem tagów."
    },
    {
      src: "/case-studies/internal-operational-spa/2_4.png",
      alt: "Szczegóły punktu usługowego (tryb jasny)",
      caption: "Widok szczegółów punktu usługowego w trybie jasnym z metadanymi lokalizacji, usługami i współrzędnymi."
    },

    {
      src: "/case-studies/internal-operational-spa/3_1.png",
      alt: "Ekran ustawień (tryb ciemny)",
      caption: "Ekran ustawień w trybie ciemnym pokazujący preferencje motywu i języka."
    },
    {
      src: "/case-studies/internal-operational-spa/3_2.png",
      alt: "Ekran ustawień (tryb jasny)",
      caption: "Ekran ustawień w trybie jasnym z kontrolą wyglądu i lokalizacji."
    },

    {
      src: "/case-studies/internal-operational-spa/4_1.png",
      alt: "Ekran logowania (Keycloak)",
      caption: "Zewnętrzna granica uwierzytelniania obsługiwana przez Keycloak, zapewniająca centralne logowanie, wybór języka i zarządzanie sesją przed wejściem do SPA."
    }
  ]}
/>
...
Nie wszystkie planowane funkcje są jeszcze zaimplementowane, a niektóre obszary są celowo minimalistyczne.
...
Projekt pokazuje, jak aplikacja frontendowa może być zaprojektowana
jako **długoterminowy system operacyjny**, nawet będąc wciąż w fazie aktywnego rozwoju.
